...
// import { useState, useEffect } from 'react';
// import { usersAPI, locationsAPI, warehousesAPI, rolesAPI } from '../../services/api';
// import type { User, Location, Warehouse, Role } from '../../types';
// import { Plus, Edit, Trash2, X, Search, Loader2 } from 'lucide-react';
// import { toast } from 'sonner';
...
//     setLoading(true);
//     try {
//       const [usersRes, locRes, whRes, rolesRes] = await Promise.all([
//         usersAPI.getAll(),
//         locationsAPI.getAll(),
...
//       const data: any = { ...formData };
//       if (!data.warehouseId) delete data.warehouseId;
//       if (!data.cppId) delete data.cppId;
//       if (!data.extensionId) delete data.extensionId;
//       if (editingUser && !formData.password) delete data.password;
...
//                     <span className="px-2 py-1 bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 rounded capitalize">
//                       {role?.name || user.role || '-'}
//                     </span>
//                   </td>
//                   <td className="px-4 py-3 text-sm">
//                     <span className={`px-2 py-1 rounded ${user.isActive ? 'bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300' : 'bg-red-100 dark:bg-red-900 text-red-700 dark:text-red-300'}`}>
...
//               {/* Submit Buttons */}
//               <div className="flex gap-4 mt-6">
//                 <button type="submit" disabled={loading} className="flex-1 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg font-semibold disabled:opacity-50 flex items-center justify-center gap-2">
...
// }
// frontend/src/app/pages/Users.tsx
// Fixed with roleId, extensionId field
